...
import {bisectFilterDataRange_columnsIndexed,
...
class YAxisTwoLevelPanel extends PureComponent {
  ...
  draw(){
    ...
    let primaryCategories_byColumn_filtered = bisectFilterDataRange_columnsIndexed(primaryCategories_byColumn,"start","end",minY,maxY);
    let secondaryCategories_byColumn_filtered = bisectFilterDataRange_columnsIndexed(secondaryCategories_byColumn,"start","end",minY,maxY);
    // Convert coordinates
